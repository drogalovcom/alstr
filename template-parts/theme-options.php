	...
	$custom_settings = array( 
		...
		'settings'        => array(
			array(
				'id'          => 'header_tab',
				'label'       => 'Основные',
				'desc'        => 'Внесите основные настройки',
				'type'        => 'tab',
				'section'     => 'settings',
			),
			array(
			...
			array(
				...
				'type'        => 'text',
				'section'     => 'settings',
				'condition'   => 'feedback_on_off:is(on)',
			),
			array(
				'id'          => 'feedback_form',
				'label'       => 'Форма обратной связи',
				'desc'        => 'Вставьте шорткод формы из плагина Contact Form 7',
				'type'        => 'text',
				'section'     => 'settings',
				'condition'   => 'feedback_on_off:is(on)',	
			),
